...
FONTS_METANAME = {
    ...
    MetanameFontNames.S_CHINESE: IFont.truetype(
        f"{fonts_dir}{'noto-serif-sc-regular.ttf'}", cards_font_metaname_size_non_latin
    ),
    MetanameFontNames.T_CHINESE: IFont.truetype(
        f"{fonts_dir}{'noto-serif-tc-regular.ttf'}", cards_font_metaname_size_non_latin
    ),
    MetanameFontNames.JAPANESE: IFont.truetype(
        f"{fonts_dir}{'noto-serif-jp-regular.ttf'}", cards_font_metaname_size_non_latin
    ),
    MetanameFontNames.KOREAN: IFont.truetype(
        f"{fonts_dir}{'noto-serif-kr-regular.ttf'}", cards_font_metaname_size_non_latin
    ),
