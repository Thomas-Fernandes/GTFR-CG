...
from server.src.routes.artwork_processing.process_artworks import bp_artwork_generation_process_artworks

bp_artwork_processing = Blueprint(ROUTES.art_proc.bp_name, __name__.split('.')[-1])
bp_artwork_processing.register_blueprint(bp_artwork_generation_process_artworks)
