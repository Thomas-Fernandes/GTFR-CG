...
<div align="center">
  ...
  <a href="#top"><img alt="TypeScript version" src="https://img.shields.io/badge/TypeScript-5.7.2-2d79c7?logo=typescript" width="24px" /></a>
  <a href="#top"><img alt="React version" src="https://img.shields.io/badge/React-19-5dd2f3?logo=react" width="24px" /></a>
  <a href="#top"><img alt="Tailwind version" src="https://img.shields.io/badge/Tailwind-3.4-06b6d4?logo=tailwindcss" width="24px" /></a>
  <a href="#top"><img alt="Vite version" src="https://img.shields.io/badge/Vite-6-fdd835?logo=vite" width="24px" /></a>
  <a href="#top"><img title="Docker" alt="Docker" src="https://raw.githubusercontent.com/mallowigi/iconGenerator/master/assets/icons/files/docker.svg" width="24px" /></a>
</div>
...
- The front end features 6 pages to date:
  - **Home**: the main page, where your statistics are displayed and you can navigate to the other 3 main pages described below.
  - **Artwork Generation**: where you can generate artwork from an iTunes image, a local file or a YouTube video.
    - **Processed Artworks**: where you can download a background image and a YouTube thumbnail.
  - **Lyrics**: where you can fetch lyrics from Genius and convert them to lyrics blocks.
  - **Cards Generation**: where cards are generated, based on the blocks from the Lyrics page.
