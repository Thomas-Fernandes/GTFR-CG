...
import DescriptionGeneration from "@/pages/DescriptionGeneration/DescriptionGeneration";
...
const AppRoutes = () => {
  return (
    <Routes>
      <Route path={ViewPaths.DescriptionGeneration} element={<DescriptionGeneration />} />
