...
METADATA_SEP = " ;;; "
CARDS_FONT_SIZE = {
    "tiny": 16, "small": 36, "medium": 43, "big": 64,
}
from PIL import ImageFont
FONT_ASCII_ABSPATH = f"{FONTS_DIR}{'programme-light.ttf'}"
FONT_TRANSLATION = ImageFont.truetype(FONT_ASCII_ABSPATH, CARDS_FONT_SIZE["big"])
FONT_LYRICS = ImageFont.truetype(FONT_ASCII_ABSPATH, CARDS_FONT_SIZE["tiny"])
FONT_METANAME = ImageFont.truetype(FONT_ASCII_ABSPATH, CARDS_FONT_SIZE["medium"])
FONT_OUTRO = ImageFont.truetype(FONT_ASCII_ABSPATH, CARDS_FONT_SIZE["small"])
...
Y_METADATA = 964
Y_BOTTOM_LYRICS = 790
TRANSLATION_HEIGHT = 94
TRANSLATION_SPACING = 13
TRANSLATION_BOX_OFFSET = 16
TRANSLATION_TEXT_OFFSET = 20
LYRIC_HEIGHT = TRANSLATION_HEIGHT / 4
LYRIC_SPACING = TRANSLATION_SPACING / 4
LYRIC_BOX_OFFSET = TRANSLATION_BOX_OFFSET / 4
LYRIC_TEXT_OFFSET = TRANSLATION_TEXT_OFFSET / 4